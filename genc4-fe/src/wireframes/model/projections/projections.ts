...
export const getContainers = (state: AssetsStateInStore) => state.assets.containers;
export const getComponents = (state: AssetsStateInStore) => state.assets.components;
